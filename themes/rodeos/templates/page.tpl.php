...
<div class="layout-center">
  ...
  <header class="header" role="banner">
    ...
    <?php if ($is_front && ($site_name || $site_slogan)): ?>
  ...
  <div class="layout-3col layout-swap">
    ...
    <main class="<?php print $content_class; ?>" role="main">
      ...
      <!--a href="#skip-link" class="visually-hidden__focusable" id="main-content">Back to top</a-->
    ...
    <div class="layout-swap__top layout-3col__full">
      ...
      <!--a href="#skip-link" class="visually-hidden__focusable" id="main-menu" tabindex="-1">Back to top</a-->
