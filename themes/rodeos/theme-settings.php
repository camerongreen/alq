 ...
 */
function rodeos_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['rodeos_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('rodeos sample setting'),
  '#default_value' => theme_get_setting('rodeos_example'),
