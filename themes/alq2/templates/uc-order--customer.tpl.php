                ...
                <tr valign="top">
                    <td>
                      ...
                      <?php if ($thank_you_message): ?>
                          <p>
                              <b><?php print t('Thanks for your order, !order_first_name!', ['!order_first_name' => $order_first_name]); ?></b>
                          </p>
                      <?php endif; ?>
                                ...
                                <td colspan="2">
                                    ...
                                    <table border="0" cellpadding="1"
                                      ...
                                      <?php endforeach; ?>
                                        ...
                                        <tr>
                                            <td nowrap="nowrap">
                                                <b><?php print t('Total for this Order:'); ?>
                                                    &nbsp;</b>
                                            </td>
                                            <td>
                                                <b><?php print $order_total; ?></b>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <br/><br/><b><?php print t('Products on order:'); ?>
                                                    &nbsp;</b>
                              ...
                              <tr>
                                  <td colspan="2">
                                    ...
                                    <?php if (FALSE && $help_text): ?>
                                      <?php print t('To learn more about managing your orders on !store_link, please visit our <a href="!store_help_url">help page</a>.', [
