...
<form class="form-horizontal" id="membershipForm" method="post"
            ...
            <div class="radio">
                <label id="newsletterEmail">
                    <input type="radio" name="newsletter" id="newsletterEmail"
                           value="Email newsletter" checked="checked "/>
                    Newsletter
                    by email
                </label>
                <label id="newsletterPrint">
                    <input type="radio" name="newsletter" id="newsletterPrint"
                           value="Printed newsletter"/> Printed newsletter by
                    post
                </label>
            </div>
        </div>
        ...
        <div class="col-sm-offset-3 col-sm-9">
            <div class="checkbox">
                <label id="spam">
                    ...
                    Join the Animal Liberation Qld email list? (1-2 emails per
                    month)
                </label>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-5">
            <button type="submit" id="membershipFormSubmit"
