...
pushd $PUBLIC_DIR
drush dis toolbar
drush en admin admin_menu contact ctools context context_ui date delta delta_ui devel features email imce advanced_help entity googleanalytics imageapi libraries module_filter omega omega_tools pathauto site_map strongarm token imce_wysiwyg jquery_plugin jquery_update wysiwyg views views_ui views_slideshow views_slideshow_cycle webform xmlsitemap
popd
