...
this.testDefaultMinister = function (browser) {
  ...
  browser.click('#suburb-default', function() {
    ...
    this.expect.element('#edit-emailee-name').to.have.value.that.equals('Minister for Agriculture');
  });
  browser.end();
};
...
this.testSearchBySuburb = function (browser) {
  ...
  browser.expect.element('#edit-emailee-name').value.to.not.be.empty;
